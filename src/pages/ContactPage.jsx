const ContactPage = () => {
  return (
    <section className="bg-transparent py-3 py-md-5 text-light">
      <div className="container">
        <div className="row gy-3 gy-md-4 gy-lg-0 align-items-md-center">
          ...
          <div className="col-12 col-lg-6">
            <div className="border-custom rounded shadow-sm overflow-hidden">
              <form action="#!">
