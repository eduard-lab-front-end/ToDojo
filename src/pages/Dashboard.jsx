...
const Dashboard = () => {
  return (
    <section className="py-5 py-xl-8 text-light">
      <div className="container">
        <div className="row justify-content-md-center">
          <div className="col-12 col-md-10 col-lg-8 col-xl-7 col-xxl-6">
            <h2 className="mb-4 display-5 text-center">
              The Finest ToDojo Agency
            </h2>
            ...
            <div className="text-center">
              <div className="d-flex align-items-center justify-content-center mb-3 mx-auto bsb-circle">
                <svg
                  ...
                  height="48"
                  fill="currentColor"
                  className="bi bi-activity text-white"
                  viewBox="0 0 16 16"
                >
                  <path
                    fillRule="evenodd"
              ...
              <p className="m-0">Issues Solved</p>
            </div>
          </div>
          <div className="col-6 col-lg-3">
            <div className="text-center">
              ...
              <p className="m-0">Finished Projects</p>
            </div>
          </div>
          <div className="col-6 col-lg-3">
            <div className="text-center">
              ...
              <p className="m-0">Awwwards Winning</p>
            </div>
          </div>
        </div>
      </div>
